...
@patch('src.amazon_books_scraper.interfaces._get_random_x_y', return_value=(5, 15))
@patch('src.amazon_books_scraper.interfaces._use_selenium', return_value=False)
class TestCase(unittest.TestCase):

    @pytest.mark.vcr
    def test_get_book_price_simple(self, _mock1, _mock2):
    ...
    @pytest.mark.vcr
    def test_get_book_price_unity_ai(self, _mock1, _mock2):
    ...
    @pytest.mark.vcr
    def test_get_book_price_kindle_not_first_in_string(self, _mock1, _mock2):
        book_name = 'Bible 101'
    ...
    @pytest.mark.vcr
    def test_get_book_price_audible_audiobook(self, _mock1, _mock2):
    ...
    @pytest.mark.vcr
    def test_get_not_found_book(self, _mock1, _mock2):
    ...
    @pytest.mark.vcr
    def test_get_not_found_audiobook(self, _mock1, _mock2):
        book_name = 'AI and ML Powering the Agents of Automation'
        author = 'Deepika M, Vijay Cuddapah, Amitendra Srivastava, Srinivas Mahankali'
        price = get_book_price(human_name=book_name, author=author, book_type=BookType.AUDIOBOOK)
        assert price['price'] == ''
    ...
    @pytest.mark.vcr
    def test_find_comics(self, _mock1, _mock2):
    ...
    @pytest.mark.vcr
    def test_find_comics_strips_unnecessary_words_from_author(self, _mock1, _mock2):
    ...
    @pytest.mark.vcr
    def test_slaine(self, _mock1, _mock2):
